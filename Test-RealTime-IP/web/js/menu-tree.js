  ...
  const groups = [
    {
      ...
      expanded: true,
      items: [
        { href: "dashboard.html", label: "Home", img: "/images/icon/Dashboard.png" },
        { href: "solar.html", label: "Network", img: "/images/icon/network.png" },
        { href: "Sld.html", label: "MV SWG", img: "/images/icon/Sld.png" },
        { href: "MultiTrend.html", label: "Multi-Trend", img: "/images/icon/trend.png" },
        { href: "MultiTrendHistory.html", label: "Multi-Trend History", img: "/images/icon/History.png" }
      ],
    },
    {
      id: "g_devices",
      ...
      expanded: true,
      items: [
        { href: "inverter.html", label: "Inverters", img: "/images/icon/inverter.png" },
        { href: "EnergyMeter.html", label: "Energy Meters", img: "/images/icon/power-meter.png" },
        { href: "ProtectionRelay.html", label: "Protection Relays", img: "/images/icon/protection%20relay.png" },
        { href: "WeatherStation.html", label: "Weather Station", img: "/images/icon/weather-station.png" }
      ],
    },
    {
      id: "g_external",
      name: "External",
      expanded: true,
      items: [{ href: "http://192.168.1.2:3000/user-interface", label: "User-Administration", img: "/images/icon/User.png" },
        { href: "http://192.168.1.2:3000/alarm", label: "Alarms", img: "/images/icon/Alarm.png" }
      ],
    },
  ];
